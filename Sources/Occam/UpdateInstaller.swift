...
enum UpdateInstaller {
    ...
    /// The team ID from the running app's code signature.
    ...
    static func downloadAndInstall(
        ...
        let tempDir = fm.temporaryDirectory
            .appendingPathComponent("com.occam.launcher.update")
        ...
        URLSession.shared.downloadTask(with: url) { localURL, response, error in
            ...
            do {
                ...
                // Extract with ditto (preserves code signatures and resource forks)
    ...
    /// Returns nil on success, or an InstallError on failure.
