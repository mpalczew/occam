...
### Fixed
- Spotlight shortcut disable failing silently on machines where the hotkey entry didn't exist
- Spotlight conflict dialog showing on every launch instead of once per version

## [1.4.5] - 2026-02-19

### Fixed
- Search results with tied fuzzy scores now ranked by recency (most recently opened app first)

## [1.4.4] - 2026-02-10

### Fixed
- CI update checker using authenticated GitHub API to avoid rate limits
